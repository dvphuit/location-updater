...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onStart() {
        ...
        bindService(new Intent(this, MyLocationService.class), mServiceConnection,
    ...
    protected void onResume() {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(myReceiver,
                new IntentFilter(MyLocationService.ACTION_BROADCAST));
    }
    ...
    /**
     * Receiver for broadcasts sent by {@link MyLocationService}.
     */
